...
inline constexpr bool game_over(const GAMESTATE *gs) {
...
extern void get_valid_moves(MOVES_LIST *list, const GAMESTATE *gs);
extern void get_valid_mask(MOVES_LIST *list, const GAMESTATE *gs);
